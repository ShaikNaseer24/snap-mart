...
export default function Store4() {
  return (
    <div><hr></hr>
    <h1 class="text-center "> <FcBookmark size={50}/>Snap mart store in Pune  <FcBookmark size={50}/></h1> 
 <hr></hr>  <div class="row" >
     <div class="col">
<img class="card-img-top" src={imgs38} alt="Card image"/>
<div class="card-body">
 <h4 class="card-title text-primary">Pune</h4>
