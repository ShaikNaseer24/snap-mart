...
export default function Store5() {
  return (
    <div><hr></hr>
    <h1 class="text-center "> <FcBookmark size={50}/>Snap mart store in Delhi  <FcBookmark size={50}/></h1> 
 <hr></hr>  <div class="row" >
     <div class="col">
<img class="card-img-top" src={imgs35} alt="Card image"/>
<div class="card-body">
 <h4 class="card-title text-primary">Delhi</h4>
