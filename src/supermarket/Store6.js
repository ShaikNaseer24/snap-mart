...
export default function Store6() {
  return (
    <div><hr></hr>
    <h1 class="text-center "> <FcBookmark size={50}/>Snap mart store in Hyderabad  <FcBookmark size={50}/></h1> 
 <hr></hr>  <div class="row" >
     <div class="col">
<img class="card-img-top" src={imgs36} alt="Card image"/>
<div class="card-body">
 <h4 class="card-title text-primary">Hyderabad</h4>
